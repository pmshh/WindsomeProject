...
import com.windsome.dto.board.review.ItemListDto;
...
public interface ItemRepository extends JpaRepository<Item, Long>, QuerydslPredicateExecutor<Item>, ItemRepositoryCustom {
    ...
    @Query(value = "select new com.windsome.dto.board.review.ItemListDto(im.imgUrl, i.id, i.itemNm, i.price, i.discount) from Item i join ItemImg im on i.id = im.item.id where im.repImgYn = 'Y' and i.itemNm like %:itemNm% order by i.id desc")
